(function () {
  const state = {
    lang: localStorage.getItem("philips-oneblade-clean-lang") || "zh"
  };
  ...
  function renderProductDetail() {
    ...
    document.title = `${productName(product)} | Philips Oneblade`;
      ...
      <section class="detail-hero">
        <div class="detail-copy">
          ...
          <div class="detail-actions">
            <strong>${product.price}</strong>
            <a class="primary-btn" href="mailto:hello@philips-oneblade-home.example">${t("detail.contact")}</a>
          </div>
  ...
  function applyLanguage(lang) {
    state.lang = lang;
    localStorage.setItem("philips-oneblade-clean-lang", lang);
